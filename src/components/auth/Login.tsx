...
const Login: React.FC<LoginProps> = ({ onGoToRegister, onLoginSuccess }) => {
  ...
  return (    <Glass className="max-w-md w-full mx-auto p-8 rounded-2xl bg-white border border-gray-200">
      ...
      >
        ...
        <p className="text-primary/60">Sign in to continue your AI journey</p>
      </motion.div>
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <div className="flex flex-col gap-4">
          ...
          <button
            ...
            className="flex justify-center items-center gap-2 py-3 px-4 rounded-xl border border-accent bg-accent/10 hover:bg-accent/20 text-primary transition-colors"
          >
